...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/=====Sem img no momento======" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Hipótese do Negócio para o MVP"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/jornada_de_usuario2.png" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Jornada do Usuário"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">TÉCNICA</h4>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/visaoProduto.png" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Visão do Produto"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/img1-comoNosPodemos.png" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img como Nos Podemos"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">TÉCNICA</h4>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/imgHistoriaUsuario.jpg" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img historia Usuario"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">TÉCNICA</h4>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/testUsuario.jpg" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Testes com Usuários"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">TÉCNICA</h4>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/propostaMvpImg1.jpg" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Proposta MVP"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">ATIVIDADE</h4>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/feira-servicos.png" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Feira e Caldeirão de Serviços"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">ATIVIDADE</h4>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        ...
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img disney Adaptado"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">METODOLOGIA</h4>
        <p style="margin: 0; padding-top: 10px;">A Metodologia Disney é uma abordagem estruturada que promove criatividade e inovação por meio de três perspectivas, focando na exploração criativa, planejamento realista e crítica construtiva para transformar ideias em planos viáveis.</p>
        <br>
        <p style="margin: 0; color: #5f6368; font-weight: 400;">Pertence a seguinte fase do Calliandra:</p>
        <span style="background-color: #F55747; color: black; padding: 4px 8px; border-radius: 12px; font-size: 12px; margin-right: 8px;">Não possui</span>
        <br>
...
<div style="flex-direction: row; box-sizing: border-box; display: flex; border: 1px solid #f0f0f0; border-radius: 4px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 16px;">
    <img 
        src="./assets/===== NAO TEM IMG ====" 
        style="max-width: 244px; height: auto; border-radius: 4px; object-fit: cover; align-self: flex-start;"  
        alt="img Colcha de Retalhos"
    >
    <div style="flex-direction: column; box-sizing: border-box; align-self: flex-start; align-items: flex-start; padding-left: 50px; margin: 0;">
        <h4 style="margin: 0; color: #5f6368; font-weight: 400;">TÉCNICA</h4>
        <p style="margin: 0; padding-top: 10px;">A técnica da "Colcha de Retalhos" usa a ideia de costurar pedaços de tecido para promover a troca de conhecimentos em oficinas. A colcha representa o aprendizado colaborativo entre os participantes.</p>
        <br>
        <p style="margin: 0; color: #5f6368; font-weight: 400;">Pertence a seguinte fase do Calliandra:</p>
        <span style="background-color: #F55747; color: black; padding: 4px 8px; border-radius: 12px; font-size: 12px; margin-right: 8px;">Não possui</span>
        <br>
